#Упражнение 8 из ОГЭ. Реализован варианты как с двумя множествами запросов, так и с тремя
#Как и в предыдущем примере, сразу подготовил переменную, содержащую в себе готовый отве
#так сказать, задел на проверялку)
import random
import prettytable
...
variants = {2: v2, 3: v3}
print(variants[random.randint(2, 3)]())
